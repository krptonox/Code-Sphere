...
function FeedPage() {
  ...
  return (
    <div className='h-screen w-screen bg-gray-900 flex items-center justify-center'>
      <div className='h-screen w-[15%] flex flex-col items-center justify-baseline bg-gray-800 border-r-[1px] border-gray-600 m-0'>
        <h1 className='font-Segoe-UI text-white bg-gray-700 w-full h-[8%] flex items-center justify-center text-2xl border-b-[1px] border-gray-600 mb-[5%]'>CodeSphere.</h1>
        <div className='w-full h-[50%] flex flex-col items-center justify-start gap-4'>
          ...
          <button className="w-[70%] h-[12%] text-gray-300 pl-[5%] focus:bg-gray-600 rounded-[5px] transition-all ease-[0.3s] hover:bg-gray-500 hover:text-white focus:border-l-[8px] focus:text-white border-green-600 font-google-sans-font-300 flex flex-col text-left justify-center">Settings</button>
        </div>
      </div>
